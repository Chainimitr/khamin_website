...
const villages = [
  "หมู่ที่1 บ้านดงมะไฟ",
  "หมู่ที่2 บ้านขมิ้น",
  "หมู่ที่3 บ้านผักขะย่า",
  "หมู่ที่4 บ้านโคกเลาะ",
  "หมู่ที่5 บ้านโคกเลาะน้อย",
  "หมู่ที่6 บ้านโพนบก",
  "หมู่ที่7 บ้านน้อยหัวคู",
  "หมู่ที่8 บ้านพาน",
  "หมู่ที่9 บ้านประชาสุขสันต์",
  "หมู่ที่10 บ้านพานพัฒนา",
  "หมู่ที่11 บ้านนาเรือง",
  "หมู่ที่12 บ้านดงมะไฟพัฒนา",
  "หมู่ที่13 บ้านดงมะไฟสามัคค",
  "หมู่ที่14 บ้านโคกเลาะกลาง",
];
    ...
    <div class="modal" style="max-width:520px">
      ...
      <div class="modal-body" style="text-align:center">
        ...
        <div class="footer-actions" style="justify-content:center; margin-top:14px">
          <a class="btn primary" href="track.html?code=${encodeURIComponent(
            code,
          )}">ไปหน้าติดตามทันที</a>
        </div>
      </div>
...
(function init() {
  ...
  $("#btnPickVillage")?.addEventListener("click", () =>
    openOverlay($("#villageOverlay")),
  );
